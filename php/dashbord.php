...
<body>
    ...
    <div class="sidebar-container">
        ...
        <ul class="sidebar-navigation">
            ...
            <li>
                <a href="dashbord.php">
                    <i class="fa fa-home" aria-hidden="true"></i> Dashbord
                </a>
            </li>
            <li>
                <a href="bookAppoinment.php?p_id=<?php echo $_SESSION['p_id'] ?>">
                    <i class="fa fa-tachometer appoinment" aria-hidden="true"></i> Book Appoinment
                </a>
            </li>
            <li>
                <a href="#">
            ...
            <li>
                <a href="#">
                    <i class="fa fa-tachometer" aria-hidden="true"></i> Doctors
                </a>
            </li>
            <li>
                <a href="#">
                    <i class="fa fa-tachometer" aria-hidden="true"></i> Appoinment History
                </a>
            </li>
            <li class="header">Another Menu</li>
            <li>
                <a href="#">
                    <i class="fa fa-users" aria-hidden="true"></i> Feedback
                </a>
            </li>
            <li>
                <a href="#">
                    <i class="fa fa-cog" aria-hidden="true"></i> Career
                </a>
            </li>
            <li>
                <a href="#">
